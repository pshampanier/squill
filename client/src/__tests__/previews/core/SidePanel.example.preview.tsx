...
export default function SidePanelExample() {
  ...
  return (
    <>
      ...
      <div className="flex flex-row w-full h-14 overflow-hidden bg-gray-200  dark:bg-gray-700">
        <SidePanel className="bg-gray-300 dark:bg-gray-600 rounded p-4 w-32" visible={leftPanelVisible} variant="left">
          LEFT
        </SidePanel>
