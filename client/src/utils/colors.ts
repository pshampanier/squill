...
export const PRIMARY_COLORS: Record<Colors, string> = {
  ...
  "solid:background": "bg-blue-600 dark:bg-blue-500",
  "danger-background": "bg-red-600 dark:bg-red-500",
  "danger-border": "border-red-600 dark:border-red-500",
  "hover:danger-background": "hover:bg-red-700 dark:hover:bg-red-600",
  "hover:danger-border": "hover:border-red-700 dark:hover:border-red-600",
  text: "text-gray-600 dark:text-gray-100",
  "hover:text": "hover:text-white dark:hover:text-white",
  "solid:text": "text-white dark:text-gray-200",
  ...
  "info:background": "bg-blue-50 dark:bg-blue-800/10",
  "success:background": "bg-teal-50 dark:bg-teal-800/10",
  "warning:background": "bg-yellow-50 dark:bg-yellow-800/10",
  "danger:background": "bg-red-50 dark:bg-red-800/10",
  "message:border": "border-gray-100 dark:border-white/10",
  "info:border": "border-blue-100 dark:border-blue-900",
  "success:border": "border-teal-100 dark:border-teal-900",
  "warning:border": "border-yellow-100 dark:border-yellow-900",
  ...
  "success:icon": "text-teal-500",
  "warning:icon": "text-yellow-500",
  "danger:icon": "text-red-500",
  "message:icon": "text-gray-400",
};
...
export const SECONDARY_COLORS: Record<Colors, string> = {
  ...
  "solid:background": primary("solid:background"),
  text: "text-gray-600 dark:text-gray-300",
  "hover:text": primary("hover:text"),
  "solid:text": primary("solid:text"),
